...
function AuthSection({ type = 'login' }: AuthSectionProps) {
  const data: any = authData[type];
          ...
          <div className="w-full lg:w-1/2 p-8">
            <Card>
              ...
              <div className="mb-8 grid space-y-3">
                {data.socialProviders.map((provider: any, index: number) => (
                  <button
                    key={index}
                    type="button"
          ...
          <div className="w-full lg:w-1/2 p-8">
            <div className="text-center">
              ...
              <div className="flex flex-wrap justify-center items-center -m-4">
                {data.trustedCompanies?.map((company: any, index: number) => (
